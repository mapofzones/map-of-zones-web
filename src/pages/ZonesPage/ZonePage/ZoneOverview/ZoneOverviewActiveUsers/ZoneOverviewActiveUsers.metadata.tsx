...
export const ACTIVE_USERS_CARD_METADATA: ActiveUsersOverviewCardMetadata = {
  ...
  dataset: {
    dailyActiveUsers: {
      ...
      numberType: NumberType.Number,
      legendValueAccessorKey: 'totalDailyActiveUsers',
      chartValueAccessorKey: 'dailyActiveUsers',
    ...
    pending: {
      ...
      legendValueAccessorKey: 'totalIbcDailyActiveUsers',
      chartValueAccessorKey: 'ibcDailyActiveUsers',
      numberType: NumberType.Number,
      size: ElementSize.LARGE,
      showPeriod: false,
