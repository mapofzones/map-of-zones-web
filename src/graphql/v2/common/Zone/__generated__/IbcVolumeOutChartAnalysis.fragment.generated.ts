...
export type IbcVolumeOutChartAnalysisFragment = {
  ibcVolumeOutChart: Array<{ value?: any | null; time: number }>;
};

export const IbcVolumeOutChartAnalysisFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
...
} as unknown as DocumentNode<IbcVolumeOutChartAnalysisFragment, unknown>;
