...
export type IbcVolumeInFieldAnalysisFragment = {
  ibcVolumeIn: { aggregate?: { sum?: { volumeIn?: any | null } | null } | null };
};

export const IbcVolumeInFieldAnalysisFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
...
} as unknown as DocumentNode<IbcVolumeInFieldAnalysisFragment, unknown>;
