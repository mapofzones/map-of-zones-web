...
export type IbcVolumeFieldAnalysisFragment = {
  ibcVolume: { aggregate?: { sum?: { volume?: any | null } | null } | null };
};

export const IbcVolumeFieldAnalysisFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'IbcVolumeFieldAnalysis' },
      typeCondition: {
        kind: 'NamedType',
...
} as unknown as DocumentNode<IbcVolumeFieldAnalysisFragment, unknown>;
