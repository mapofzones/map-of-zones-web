...
export type IbcTransfersInChartAnalysisFragment = {
  ibcTransfersInChart: Array<{ value?: any | null; time: number }>;
};

export const IbcTransfersInChartAnalysisFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
                        ...
                        fields: [
                          {
                            ...
                            value: { kind: 'StringValue', value: 'transfers_in', block: false },
                          },
                        ],
                      },
                    },
...
} as unknown as DocumentNode<IbcTransfersInChartAnalysisFragment, unknown>;
