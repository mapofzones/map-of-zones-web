...
export type IbcTransfersInFieldAnalysisFragment = {
  ibcTransfersIn: { aggregate?: { sum?: { value?: any | null } | null } | null };
};

export const IbcTransfersInFieldAnalysisFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
...
} as unknown as DocumentNode<IbcTransfersInFieldAnalysisFragment, unknown>;
