...
export type IbcTransfersChartAnalysisFragment = {
  ibcTransfersChart: Array<{ value?: any | null; time: number }>;
};

export const IbcTransfersChartAnalysisFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
...
} as unknown as DocumentNode<IbcTransfersChartAnalysisFragment, unknown>;
