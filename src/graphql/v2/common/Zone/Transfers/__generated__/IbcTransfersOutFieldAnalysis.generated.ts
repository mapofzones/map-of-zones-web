...
export type IbcTransfersOutFieldAnalysisFragment = {
  ibcTransfersOut: { aggregate?: { sum?: { value?: any | null } | null } | null };
};

export const IbcTransfersOutFieldAnalysisFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
...
} as unknown as DocumentNode<IbcTransfersOutFieldAnalysisFragment, unknown>;
