...
import { TOTAL_IBC_TRANSFERS_CARD_FRAGMENT } from 'graphql/common/Cards/TotalIbcTransfersCard.fragment';
import { TOTAL_IBC_VOLUME_CARD_FRAGMENT } from 'graphql/common/Cards/TotalIbcVolumeCard.fragment';
